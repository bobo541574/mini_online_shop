...
class HomeController extends Controller
{
    public function index()
    {
        ...
        return view('home', compact('categories', 'latestProducts', 'popularProducts', 'adminProducts'));
    }

    public function subcategoryByProducts(Category $subcategory)
    {
        $categories = Category::with('subcategories')->whereNull('parent_id')->get();
        $products = Product::with('category', 'subcategory', 'brand', 'attribute')->where('sub_category_id', $subcategory->id)->paginate(12);

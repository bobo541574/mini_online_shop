            ...
            <div class="card-body">
                <form action="{{ route('colors.update', $color) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name_en" value="{{ $color->name_en }}" id="name_en" class="form-control"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name_mm" value="{{ $color->name_mm }}" id="name_mm" class="form-control"

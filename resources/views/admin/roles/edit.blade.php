            ...
            <div class="card-body">
                <form action="{{ route('roles.update', $role) }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name_en" value="{{ $role->name_en }}" id="name_en" class="form-control"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name_mm" value="{{ $role->name_mm }}" id="name_mm" class="form-control"

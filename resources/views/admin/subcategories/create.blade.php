                ...
                <form action="{{ route('subcategories.store') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="parent_id" aria-label="Default select example">
                            ...
                            <option value="{{ $category->id }}" {{ ($category->id == old('parent_id')) ? 'selected=selected' : '' }}>
                    ...
                    <div class="mb-3">
                        <label for="description_en"
                            class="form-label fw-bold">@lang('subcategory_description_en')</label>
                        <textarea name="description_en" id="description_en" rows="3" class="form-control"
                            placeholder="@lang('enter_subcategory_description_en')">{{ old('description_en') }}</textarea>
                    ...
                    <div class="mb-3">
                        <label for="description_mm"
                            class="form-label fw-bold">@lang('subcategory_description_mm')</label>
                        <textarea name="description_mm" id="description_mm" rows="3" class="form-control"
                            placeholder="@lang('enter_subcategory_description_mm')">{{ old('description_mm') }}</textarea>
